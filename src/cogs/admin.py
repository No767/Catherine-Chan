...
from utils.pages.paginator import CatherineContextPages
...
class BlacklistPageSource(menus.AsyncIteratorPageSource):
    ...
    async def format_page(  # type: ignore
        self, menu: CatherineContextPages, entries: list[str]
    ) -> discord.Embed:
        pages = []
...
class Admin(commands.Cog, command_attrs={"hidden": True}):
    ...
    async def add(self, ctx: commands.Context, obj: discord.Object):
    ...
    async def remove(self, ctx: commands.Context, obj: discord.Object):
