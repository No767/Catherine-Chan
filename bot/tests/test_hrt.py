...
@pytest.fixture
def ctx_cog(bot) -> HRTConversion:
    return HRTConversion(bot)


def test_calc_e(ctx_cog: HRTConversion):
    pm_convert = ctx_cog.calc_e(AMOUNT, "pmol_l")
    pg_convert = ctx_cog.calc_e(AMOUNT, "pg_ml")
...
def test_calc_prolac(ctx_cog: HRTConversion):
    miu_convert = ctx_cog.calc_prolac(AMOUNT, "miu_l")
    ng_convert = ctx_cog.calc_prolac(AMOUNT, "ng_ml")
...
def test_calc_t(ctx_cog: HRTConversion):
    nm_convert = ctx_cog.calc_t(AMOUNT, "nmol_l")
    ng_convert = ctx_cog.calc_t(AMOUNT, "ng_dl")
...
def test_calc_prog(ctx_cog: HRTConversion):
    nm_convert = ctx_cog.calc_prog(AMOUNT, "nmol_l")
    ng_convert = ctx_cog.calc_prog(AMOUNT, "ng_ml")
