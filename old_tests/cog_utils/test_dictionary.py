...
from libs.cog_utils.dictionary.utils import (
    format_inline_references,
    format_link_references,
    format_multi_reference,
    format_pronouns_references,
...
EASY_PRONOUNS = (
    "It is also common to use {/they/them/themself=“themself”} as a reflexive form."
)
EASY_KNOWN_PRONOUNS = "It is also common to use [“themself”](https://en.pronouns.page/they/them/themself) as a reflexive form."

KNOWN_PRONOUNS = "/she/her=she"
FORMATTED_KNOWN_PRONOUNS = "[she](https://en.pronouns.page/she/her)"


def test_format_pronouns_references():
    pronouns_link = format_pronouns_references(KNOWN_PRONOUNS)
    assert pronouns_link == FORMATTED_KNOWN_PRONOUNS
...
def test_format_inline_references():
    ...
    formatted_pronouns_link = format_inline_references(EASY_PRONOUNS)
    assert formatted_pronouns_link == EASY_KNOWN_PRONOUNS
